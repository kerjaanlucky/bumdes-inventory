...
export interface SaleItem {
  ...
  diskon: number
  subtotal: number
  jumlah_diretur?: number // Qty yang sudah diretur (akumulasi bertahap). Default 0.
}
...
export interface Sale {
  ...
  branchId: string
  total_retur?: number // Akumulasi nominal refund retur per item (setelah diskon item). Default 0.
}
