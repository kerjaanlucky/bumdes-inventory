...
interface CategoryFormModalProps {
  ...
  defaultValue?: CategoryFormValues;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>{defaultValue ? "Ubah Kategori" : "Tambah Kategori Baru"}</DialogTitle>
          <DialogDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Contoh: Elektronik" {...field} disabled={isSubmitting} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
